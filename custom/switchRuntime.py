...
#sys.path.append(r'/home/p4ml/P4/behavioral-model/tools/')
...
class SwitchRuntime(object):
    ...
    def table_add(self, table_name, action_name, match_key, action_params, priority=None):
        ...
        # print(action_name, match_key, action_params)
        ...
        # DO NOT DOWN THE SAME TABLE OR IT WILL DO NOTHING
        # "/usr/local/lib/python2.7/dist-packages/bm_runtime/standard/Standard.py", line 677, has been changed
    ...
    def counter_read(self,counter_name,counter_index):
        value=self.standard_client.bm_counter_read(0,counter_name,counter_index)
        return value
    ...
    def register_read(self,register_name,register_idx):
        value = self.standard_client.bm_register_read(0,register_name,register_idx)
        return value
    
    def register_reset(self, register_name):
        value = self.standard_client.bm_register_reset(0,register_name)
        return value
